...
!(function (e, n, t) {
  ...
  function i(e) {
    ...
    Modernizr._config.enableClasses &&
      ((n += " " + t + e.join(" " + t)),
      E ? (w.className.baseVal = n) : (w.className = n));
  }
  ...
  function h(e, n, o, i) {
    ...
    for (
      var c, p, d, m, h, y = ["modernizr", "tspan", "samp"];
      !A.style && y.length;
  ...
  Modernizr.addTest("forcetouch", function () {
    return b(j("mouseforcewillbegin", e, !1), e)
