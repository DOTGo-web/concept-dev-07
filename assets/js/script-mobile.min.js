          ...
          function (t, s, h) {
            ...
            if (!b) {
              if (!(_ = "auto" === e.grid ? 0 : (e.grid || [1, L])[1])) {
                for (
                  D = -L;
                  D < (D = h[_++].getBoundingClientRect().left) && _ < w;
          ...
          if (y !== this._tTime || n || _) {
            if (
              ...
              if (
                ...
                (m = w ? 0 : D),
                (this._lock = 1),
                (this.render(m || (g ? 0 : bt(a * u)), e, !D)._lock = 0),
     ...
     */ var gn,
        ...
        return r === c || !l || ni[r] || ni[c]
          ...
          : ("px" !== c && !g && (l = t(e, n, i, "px")),
            ...
            m && (En[n] || ~n.indexOf("adius"))
              ? bt((l / (u ? e.getBBox()[f ? "width" : "height"] : e[p])) * 100)
      ...
      pi = function (t, e, n, i, r, o) {
        ...
        n
          ? c !== li &&
            (a = g * D - m * v) &&
            ((u = b * (-m / a) + E * (g / a) - (g * _ - m * y) / a),
            (b = b * (D / a) + E * (-v / a) + (v * _ - D * y) / a),
            (E = u))
          : ((b =
      ...
      gi = function (t, e) {
        ...
        return (
          ...
          m !== li &&
            ...
            6 === m.length
              ...
              : ((B = m[6]),
                ...
                (u = (v = Fn(w, _)) * Cn),
                v &&
                  ((F = _ * (D = Math.cos(v)) + w * (y = Math.sin(v))),
                  (S = C * D + x * y),
                  (w = w * D - _ * y),
                  (x = x * D - C * y),
                  (_ = F),
          ...
          (n.force3D = O.force3D),
          (n.renderTransform = n.svg ? _i : bn ? yi : Di),
          (n.uncache = 0),
          n
        );
      },
        ...
        if (S !== n || k) {
          for (St(); s < wt.length; s += 4)
            (e = o.matchMedia(wt[s]).matches) !== wt[s + 3] &&
              ((wt[s + 3] = e),
              e ? r.push(s) : St(1, wt[s]) || (X(wt[s + 2]) && wt[s + 2]()));
        ...
        if (o) {
          ...
          (p = "scroll" + i.d2),
            dt(
              ...
              i,
              (b && w > 20) ||
                (!b && (f ? Math.max(u[p], a[p]) : o.parentNode[p]) <= w + 1)
            ),
            f &&
              ((c = it(s)),
              ...
              (ve.refresh = function (r) {
                if (!v && ve.enabled)
                  if (Zt && r && M) st(t, "scrollEnd", Et);
                    ...
                    for (
                      y =
                        Rt(P, Jt, D, Yt, ve.scroll(), b, S, ve, _, me, fe, C) ||
                        (Zt ? -0.001 : 0),
                        X(k) && (k = k(ve)),
                        Y(k) &&
                          !k.indexOf("+=") &&
            ...
            function a(e) {
              if (
                ...
                var g = l.paddingLeft + l.paddingRight,
                  ...
                  w = c && o,
                  b = t(u.width);
                !1 !== b && (l.width = b + (w ? 0 : g + y));
                var E = t(u.height);
                return (
                  !1 !== E && (l.height = E + (w ? 0 : m + _)),
  ...
  function (t, e, n) {
    ...
    !(function (o, a) {
      ...
      var t = "undefined" != typeof window,
        ...
        d = function (t, e) {
          (t.loadingCount += e),
            0 === t._elements.length &&
              0 === t.loadingCount &&
              f(t._settings.callback_finish, t);
        },
        p = function (t) {
        ...
        m = function (t, e) {
          g(t, "sizes", a(t, e.data_sizes)),
            g(t, "srcset", a(t, e.data_srcset)),
        ...
        E = function (t, e, n) {
          var i = n._settings,
            ...
            s = t.target;
          y(s, i.class_loading), D(s, r), f(o, s, n), d(n, -1);
        },
        C = ["IMG", "IFRAME", "VIDEO"],
        x = function (t, e) {
          var n = e._observer;
        ...
        S = function (t, e, n) {
          ...
          (!n && l(t)) ||
            ...
            f(i.callback_reveal, t, e),
            f(i.callback_set, t, e));
        },
        k = function (t) {
          return (
            !!n &&
              ...
              function (e) {
                e.forEach(function (e) {
                  return (function (t) {
                    ...
                    : (function (t, e, n) {
                        var i = n._settings;
                        f(i.callback_exit, t, e, n), i.load_delay && F(t);
                      })(e.target, e, t);
                });
              },
              {
    ...
    const m = (t, e, n, i) => {
      ...
      (document.getElementById("video-player-heading").innerHTML = n),
        ...
        f.ready().then(function () {
          w.to([s], { y: "0%", duration: 0.45, ease: "Power3.easeInOut" })
      ...
      return l.addEventListener("click", _), { player: f, destroy: b };
    };
    let v = [];
    const D = () => {
